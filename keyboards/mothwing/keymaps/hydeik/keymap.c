 ...
 */
    [_BASE] = LAYOUT_base_wrapper(
        ...
        _________________QWERTY_L3_________________, _________________QWERTY_R3_________________,
                                   TAB_EXT, SPC_NUM, ENT_SYM, ESC_FUN
    ),
/*
 ...
 * | !       | @       | #       | $       | %       |   | ^       | &       | *       | `       | ~       |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | "/LCTL  | </LALT  | {/LGUI  | (/LSFT  | [       |   | |       | _/RSFT  | =/RGUI  | +/RALT  | :/RCTL  |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | '       | >       | }       | )       | ]       |   | \       | -       | ,       | .       | ?       |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 *                               |         |         |   | *SYM*   |         |
 ...
 * | !       | @       | #       | $       | %       |   | ^       | &       | *       | +       | :       |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | 1/LCTL  | 2/LALT  | 3/LGUI  | 4/LSFT  | 5       |   | 6       | 7/RSFT  | 8/RGUI  | 9/RALT  | 0/RCTL  |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * |         |         |         |         |         |   | _       | -       | ,       | .       | /       |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 *                               |         | *NUM*   |   |         |         |
...
/*
 * Layer 5: Function and media keys
 *
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | F1      | F2      | F3      | F4      | F5      |   | MUTE    | VOLD    | VOLU    | BRID    | BRIU    |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | F6      | F7      | F8      | F9      | F10     |   |         | RSFT    | RGUI    | RALT    | RCTL    |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 * | F11     | F12     |         |         | PrScr   |   | LLOCK   | MSTP    | MPRV    | MPLY    | MNXT    |
 * +---------+---------+---------+---------+---------+   +---------+---------+---------+---------+---------+
 *                               |         |         |   |         | *FNC*   |
 *                               +---------+---------+   +---------+---------+
 */
